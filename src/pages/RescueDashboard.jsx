...
const slaAlerts = [
  { id: 1, text: '3 critical tasks pending >30 min', severity: 'critical' },
  { id: 2, text: '5 unassigned cases', severity: 'warning' },
]
...
export default function RescueDashboard() {
  return (
    <div className="h-screen flex flex-col" style={{ fontFamily: 'var(--font-body)' }}>
      ...
      {/* Push content below navbar — the navbar is fixed and ~96px tall (alert banner + nav) */}
