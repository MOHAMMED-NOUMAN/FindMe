...
import {
  ...
  ChevronDown, ChevronUp, Loader2, CheckCircle2, RefreshCw, Bell
} from 'lucide-react'
...
export default function SafePage() {
  ...
  const handleUpdateLocation = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      () => { alert('Unable to retrieve location. Enable permissions.'); setLocLoading(false) },
      { timeout: 10000 }
    )
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-5 py-20"
        ...
        >
          ...
          <button
            onClick={() => { setDone(false); setPhone('') }}
    ...
    <div className="min-h-screen px-5 pt-28 pb-20 max-w-lg mx-auto"
      ...
      >
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-3">
          ...
          >
            {locLoading ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <RefreshCw className="w-3.5 h-3.5" />}
...
/>
          ...
          >
            ...
            {sending ? 'Notifying…' : 'Notify My Contacts'}
          </motion.button>
        </div>
